...
let bookingsController = {
    ...
    async bookingCourse(req, res, next){
        try{
            ...
            const localDate = startTransfer.toLocaleString('en-US', { timeZone: 'Asia/Taipei', hour12: false });
            const localDate2 = endTransfer.toLocaleString('en-US', { timeZone: 'Asia/Taipei', hour12: false});
